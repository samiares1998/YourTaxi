                    ...
                    <form method="POST" action="{{ route('ingresar') }}">
                        ...
                        <div class="form-group row">
                          ...
                          <select  name="tipo" class="form-control">
                           <option   id="contar" name="tipo" value="1">Cliente</option>
                           <option   id="contar" name="tipoUser" value="2">Operador</option>
                           <option   id="contar" name="tipoUser" value="3">Conductor</option>
                           <option   id="contar"  name="tipoUser" value="4">Administrador</option>
                            </select>
                          </div>
                        </div>
