...
<div class="card-header d-flex align-items-center">
                      <h3 class="h4">Editar tarifa de afiliacion</h3>
                    </div>
                    <div class="card-body">
                      <form class="form-horizontal" action="{{ url('/editarTarifa',[$tarifa->id]) }}" method="post">
                        {{ csrf_field() }}
                        <div class="form-group row">
                          <label class="col-sm-3 form-control-label">valor</label>
                          <div class="col-sm-9">
                            <input type="number" class="form-control" name="valor" value="{{ $tarifa->valor }}" required>
                          </div>
                        </div>
                        <div class="line"></div>
                        <div class="form-group row">
                          ...
                          <div class="col-sm-9">
                            <input type="text" class="form-control" name="descripcion" value="{{ $tarifa->descripcion }}" required>
                          </div>
                        </div>
