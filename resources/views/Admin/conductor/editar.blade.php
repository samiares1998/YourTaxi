...
<div class="card-header d-flex align-items-center">
                    ...
                    <div class="card-body">
                      <form class="form-horizontal" action="{{ url('/edit',[$conductor->id]) }}" method="post">
                        ...
                        <div class="form-group row">
                          <label class="col-sm-3 form-control-label">propietario</label>
                          <div class="col-sm-9">
                            <input type="number" class="form-control" name="propietario" required><span class="help-block-none">solo 1 o 0</span>
                          </div>
                        </div>
                        <div class="line"></div>
