...
<div class="card-header d-flex align-items-center">
                      <h3 class="h4">Actualizar Operador</h3>
                    </div>
                    <div class="card-body">
                      <form class="form-horizontal" action="{{ url('/editOperador',[$operador->id]) }}" method="post">
                        {{ csrf_field() }}
                        <div class="form-group row">
                          <label class="col-sm-3 form-control-label">username</label>
                          <div class="col-sm-9">
                            <input type="text" class="form-control" name="username" value="{{ $operador->username}}" required>
                          </div>
                        </div>
                        ...
                        <div class="form-group row">
                          ...
                          <div class="col-sm-9">
                            <input type="text" class="form-control" name="email" value="{{ $operador->email}}" required>
                          </div>
                        </div>
                        ...
                        <div class="form-group row">
                          ...
                          <div class="col-sm-9">
                            <input type="password" name="password" class="form-control" value="{{ $operador->password}}" required>
                          </div>
                        </div>
